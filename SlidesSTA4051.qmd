...
$$H_1:  \text{At least two populations have the different medians} $$

`Data`

- C random samples and independent
...
Under Null hypothesis: $T \sim \chi^2_{C-1}$
...
`Answer:` $$H_0:  \text{All methods have the same median yield per acre} $$
$$H_0:  \text{At least two of the methods medians differ} $$
